...
const subAdminRegisterEmailTemplate = (name, otp, roleName) => {
  return `
    <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9f9f9; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
      ...
      <div style="background: linear-gradient(135deg, #0e6b53 0%, #14493b 100%); padding: 40px 20px; text-align: center;">
        ...
        <div style="font-size: 12px; color: #bff86a; letter-spacing: 2px; text-transform: uppercase;">Sub-Admin Registration</div>
      </div>
      ...
      <div style="padding: 40px 30px; background-color: #ffffff;">
        ...
        <p style="color: #555555; font-size: 15px; line-height: 1.6; margin-bottom: 15px;">Congratulations! Your Sub-Admin account has been successfully created with the following details:</p>

        <!-- Account Details Box -->
        <div style="background: linear-gradient(135deg, #eafef2 0%, #f0f9f5 100%); border: 2px solid #bff86a; border-radius: 8px; padding: 20px; margin: 20px 0;">
          <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
            <span style="color: #0e6b53; font-weight: bold;">Role:</span>
            <span style="color: #333333; font-weight: 600;">${roleName}</span>
          </div>
          <div style="border-top: 1px solid #bff86a; padding-top: 12px;">
        ...
        <div style="background-color: #eafef2; padding: 20px; border-radius: 8px; border-left: 4px solid #0e6b53; margin-bottom: 20px;">
          <p style="color: #0e6b53; font-size: 14px; font-weight: bold; margin-bottom: 8px;">Your Access Permissions:</p>
          <ul style="color: #555555; font-size: 13px; line-height: 1.8; margin: 0; padding-left: 20px;">
            <li>Access sub-admin dashboard</li>
            <li>Manage assigned user accounts</li>
            <li>Process financial transactions</li>
            <li>View reports for your department</li>
          </ul>
        </div>
