export const resetUserPasswordEmailHTML = (displayName, resetLink) => `
  <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: 0 auto; background-color: #f9f9f9; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    ...
    <div style="padding: 40px 30px; background-color: #ffffff;">
      ...
      <p style="color: #555555; font-size: 15px; line-height: 1.6; margin-bottom: 15px;">We received a request to reset your User account password. Please click the button below to reset your password:</p>

      <div style="text-align: center; margin: 35px 0;">
        <a href="${resetLink}" target="_blank" style="display: inline-block; padding: 14px 40px; background: linear-gradient(135deg, #B0FF1C 0%, #40FF00 100%); color: #000000; text-decoration: none; border-radius: 50px; font-weight: bold; font-size: 16px; border: 2px solid #000000;">
          Reset Password
        </a>
      </div>
...
export const resetUserPasswordEmailText = (displayName, resetLink) => `
SGB FINANCE - Trusted Financial Solutions

PASSWORD RESET REQUEST

Hello ${displayName},

We received a request to reset your User account password.
