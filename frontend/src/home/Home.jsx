  ...
  return (
    <div>
          ...
          <div className='flex items-center justify-between py-4 px-2 '>
            ...
            <div className='flex justify-center items-center gap-2 sm:px-5'>
              <button type="button"
                ...
                aria-label='Login'
                className='px-3 md:px-4 py-1 bg-[#E0FCED] font-bold border-[2px] border-black rounded-full md:rounded-xl text-sm shadow-[1px_3px_4px_0px_rgba(0,_0,_0,_0.1)] text-[#27563C]'
              >
              ...
              <button type="button" aria-label='Sign up' onClick={() => navigate('/signup')} className='px-3 md:px-4 py-1 bg-gradient-to-b from-[#B0FF1C] to-[#40FF00] font-bold border-[2px] border-black rounded-full md:rounded-xl text-sm shadow-[1px_3px_4px_0px_rgba(0,_0,_0,_0.1)] text-[#1E3E2B]'>
                <span className='md:hidden flex items-center justify-center' aria-hidden='true'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                    <path d="M0 0h24v24H0z" fill="none" />
      ...
      <div className='flex justify-center items-center h-fit flex-col'>
        <h1 className=' px-4 text-[3.35rem] leading-tight sm:text-[2.25rem] pt-12 md:pt-24 md:text-[2.75rem] lg:text-[3rem] xl:text-[3.5rem] font-extrabold text-[#27563C]'><span className='sm:pl-16'>Drive Your Dream,</span><br /> We Finance the Journey.</h1>
