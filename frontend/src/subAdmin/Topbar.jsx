...
function Topbar({topbarData , data}) {
    const [sidebarOpen, setSidebarOpen] = useState(true);
  return (
    <header className="w-full h-16 bg-white border-b shadow-sm flex items-center justify-between px-6 sticky top-0 z-50">

       {data  &&( <div className='p-4' onClick={() => {
        setSidebarOpen(!data)
        topbarData(!data)}
        }>
      ...
      <div className="flex items-center gap-2">
        <div className="text-xl font-bold text-gray-700">SGB Finance</div>
      </div>
