...
function Sell() {
  ...
  function buildSellerInvoice(responseData) {
    ...
    return {
      ...
      saleAmount: form.saleAmount || vehicle.bikePrice || '-',
  ...
  function onChange(e) {
    ...
    const excludeFromUpper = ['dob', 'pendingDate', 'emiDate', 'emiStartDate']
